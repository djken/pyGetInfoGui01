...
ville_label.grid(row=3, column=2)
ville_entry.grid(row=3, column=3)

ajouter_button.grid(row=4, column=0, columnspan=2, pady=10)
switch_to_display_button.grid(row=4, column=2, columnspan=2)
